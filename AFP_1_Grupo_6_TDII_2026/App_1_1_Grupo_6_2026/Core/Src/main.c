...
int main(void)
{
	...
	while (1)
	{
		...
		/* USER CODE BEGIN 3 */
				...
				/*
		         * @brief Máquina de Estados Finitos (MEF) para secuencia de LEDs.
		         * @details Esta estructura gestiona la secuencia los LEDs:
		         * 1. Estado_Encendido: Aplica el nivel lógico SET al pin.
		         * 2. Estado_Apagado: Aplica el nivel lógico RESET e incrementa el índice.
		         * Ambos estados utilizan el tiempo definido para Encendido-Apagado.
		         */
		switch (estado) {
